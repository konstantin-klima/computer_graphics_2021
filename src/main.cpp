...
GLFWwindow* setupWindow()
{
	...
	GLFWwindow* window =
		glfwCreateWindow(Settings::SCR_WIDTH, Settings::SCR_HEIGHT, "rePIT",
...
void loadModels()
{
	...
	auto spectralArrowModel = new Model(
		"resources/objects/arsenal/spectral_arrow/spectral_arrow.obj");
...
void loadShaders()
{
	...
	auto skybox = new Shader("resources/shaders/skybox.vs",
							 "resources/shaders/skybox.fs");
	ShaderManager::getManager().addShader("skybox", skybox);

	auto player = new Shader("resources/shaders/player.vs",
							 "resources/shaders/player.fs");
